// ─── POST complejo original (backup) ─────────────────────────────────────────
// Este endpoint es la versión compleja con Stripe, WhatsApp, cálculos de menú,
// capacidad, etc. Se mantiene aquí como respaldo para uso futuro.
